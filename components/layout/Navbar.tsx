          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            {mounted && (
              <button
                ...
                className="p-1.5 sm:p-2 rounded-xl transition-all hover:bg-white/10"
            ...
            <button
              ...
              className="px-2 sm:px-3 py-1 rounded-full text-[9px] sm:text-xs font-bold border-2 transition-all hover:border-primary hover:text-primary shrink-0"
              style={{
            ...
            <a
              href="#support"
              className="hidden sm:flex bubble-btn bubble-btn-primary px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm shrink-0"
            >
              {t('supportBtn')}
            </a>
            ...
            {/* Mobile hamburger */}
            <button
              className="md:hidden p-1.5 -mr-1 rounded-lg transition-colors shrink-0"
              style={{ color: (scrolled || menuOpen) ? 'var(--text-muted)' : 'rgba(255,255,255,0.85)' }}
